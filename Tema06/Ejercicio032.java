 ...
 * forma aleatoria. Por cada metro de sendero - representado por una línea - puede 
 * que haya un obstáculo o puede que no, la probabilidad es del 50%. La posición del
 * obstáculo es aleatoria dentro de la línea. En caso de existir un obstáculo en un 
 * metro de sendero (en una línea), puede ser una planta (carácter *) o una piedra
 * (carácter O), la probabilidad de que salga uno u otro es la misma. Recuerda que 
 * nunca habrá más de un obstáculo por metro de sendero, habrá uno o ninguno.
 * 
