...
public class Ejercicio020 {
  public static void main(String[] args) {
    System.out.println("El programa pinta por pantalla una cuba con cierta cantidad de agua.");
    ...
    System.out.print("\nLa cuba tiene una capacidad de " + capacidad + " litros y contiene " + litrosContenidos
        + " litros de agua.");
  }
}