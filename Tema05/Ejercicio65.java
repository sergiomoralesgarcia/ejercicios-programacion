 ...
 * introducir la altura total y la fila en la que debe aparecer el palito
 * horizontal (contando desde el vértice). La altura mínima es de 3 pisos. 
 * La fila donde va el palito horizontal debe ser mayor que 1 y menor que 
